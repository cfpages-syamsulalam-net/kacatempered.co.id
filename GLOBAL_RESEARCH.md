...
This is the reusable pre-writing evidence layer for the complete `kacatempered.co.id` catalog. It reuses authoritative research from its broader project family, then maps that evidence to this repository's frozen topic families so related sites do not repeat the same source discovery.
...
- **Purpose:** Freeze the verified editorial scope for `kacatempered.co.id` and prevent family research from overriding this project's actual catalog boundaries.
- **Summary:** `kacatempered.co.id` is a member of **F01 Glass, glazing, tempered glass, and applied film**. Shared evidence is reused here, but its applicability is filtered through this project's topic map, application, jurisdiction, product, and installed-system gates.
...
- **Incorporation:** Use in `KT-04`, `KT-07`, `KT-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-02`, `KT-04`, `KT-11`, `KT-12`, `KT-13`, `KT-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-09`, `KT-10`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-07`, `KT-12`, `KT-13`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-01`, `KT-02`, `KT-05`, `KT-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-01`, `KT-02`, `KT-03`, `KT-05`, `KT-09`, `KT-10`, `KT-11`, `KT-12`, `KT-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-03`, `KT-11`, `KT-12`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-03`, `KT-13`, `KT-14`, `KT-15`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-03`, `KT-13`, `KT-15`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-15`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-02`, `KT-04`, `KT-06`, `KT-09`, `KT-11`, `KT-12`, `KT-13`, `KT-14`, `KT-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-01`, `KT-05`, `KT-07`, `KT-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-06`, `KT-07`, `KT-09`, `KT-10`, `KT-13`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-06`, `KT-13`, `KT-15`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-07`, `KT-08`, `KT-09`, `KT-10`, `KT-14`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-01`, `KT-05`, `KT-08`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Purpose:** Create a strong safety boundary around the mapped topic family.
...
- **Incorporation:** Use in `KT-11`, `KT-12`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Retain as adjacent family evidence only. Do not force it into an outline unless a catalog brief genuinely raises this issue and its applicability is rechecked.
...
- **Incorporation:** Use in `KT-14`, `KT-15`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `KT-04`, `KT-05`, `KT-06`, `KT-08`, `KT-16`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
| --- | --- | --- | --- |
| `KT-01` | KR-05, KR-06, KR-13, KR-17 | Tempered-glass fundamentals; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-02` | KR-02, KR-05, KR-06, KR-12 | Thickness, size, loads, and specification; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-06; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-03` | KR-06, KR-07, KR-08, KR-09 | Safety-glass types and alternatives; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-04; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-04` | KR-01, KR-02, KR-12, KR-22 | Survey, design brief, budgeting, and procurement; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-06, GATE-08; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-05` | KR-05, KR-06, KR-13, KR-17, KR-22 | Fabrication and quality control; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-04, GATE-08; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-06` | KR-12, KR-14, KR-15, KR-22 | Hardware, frames, sealants, and interfaces; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-03, GATE-04, GATE-05, GATE-06; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-07` | KR-01, KR-04, KR-13, KR-14, KR-16 | Transport, storage, installation, and acceptance; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-05, GATE-06, GATE-07, GATE-08; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-08` | KR-16, KR-17, KR-22 | Breakage, defects, maintenance, and replacement; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-06, GATE-07, GATE-08; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-09` | KR-03, KR-06, KR-12, KR-14, KR-16 | Doors, folding systems, and partitions; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-02, GATE-04, GATE-05, GATE-06; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-10` | KR-03, KR-06, KR-14, KR-16 | Shower enclosures and wet-area glass; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-02, GATE-04, GATE-05, GATE-06; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-11` | KR-02, KR-06, KR-07, KR-12, KR-18 | Railings, balustrades, and fall protection; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-06, GATE-07; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-12` | KR-02, KR-04, KR-06, KR-07, KR-12, KR-18 | Canopies, roofs, skylights, and overhead glass; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-13` | KR-02, KR-04, KR-08, KR-09, KR-12, KR-14, KR-15 | Facades, curtain walls, and exterior glazing; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-14` | KR-08, KR-12, KR-13, KR-16, KR-21 | Furniture, displays, curved, printed, and decorative glass; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-04; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-15` | KR-08, KR-09, KR-10, KR-11, KR-15, KR-21 | Thermal, solar, acoustic, optical, and climate performance; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-04, GATE-05; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `KT-16` | KR-01, KR-02, KR-05, KR-06, KR-12, KR-22 | Vendor evaluation, contracts, handover, and service; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-08; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
...
| --- | --- | --- |
| `GATE-01` licensed standards | `KT-01`, `KT-02`, `KT-03`, `KT-05`, `KT-11`, `KT-12`, `KT-13`, `KT-15` | Obtain and review the current applicable SNI/standard text before using exact requirements, tolerances, classifications, test values, or acceptance criteria. |
| `GATE-02` Indonesian application and approval basis | `KT-02`, `KT-03`, `KT-09`, `KT-10`, `KT-11`, `KT-12`, `KT-13` | Identify the actual Indonesian building, accessibility, fire, safety, local-approval, and project rules for the application. |
| `GATE-03` structural and façade design | `KT-02`, `KT-06`, `KT-11`, `KT-12`, `KT-13` | A qualified professional must verify loads, support, make-up, deflection, anchors, movement, post-breakage behavior, and interfaces. |
| `GATE-04` current product and system evidence | `KT-03`, `KT-05`, `KT-06`, `KT-09`, `KT-10`, `KT-11`, `KT-12`, `KT-13`, `KT-14`, `KT-15` | Obtain exact datasheets, test reports, listings/certificates, fabrication limits, configuration, and declared limitations. |
| `GATE-05` manufacturer compatibility and installation | `KT-06`, `KT-07`, `KT-09`, `KT-10`, `KT-12`, `KT-13`, `KT-15` | Obtain written compatibility, processing, adhesion, cleaning, installation, cure, maintenance, and warranty instructions for selected products. |
| `GATE-06` site survey and exposure | `KT-02`, `KT-04`, `KT-06`, `KT-07`, `KT-08`, `KT-09`, `KT-10`, `KT-11`, `KT-12`, `KT-13` | Record dimensions, supports, substrate/frame condition, water paths, access, users, exposure, existing damage, and replacement constraints. |
| `GATE-07` K3 and safe-access method | `KT-07`, `KT-08`, `KT-11`, `KT-12`, `KT-13` | Review current work-at-height provisions and approve a task-specific method, competent team, exclusion zones, lifting/access controls, and rescue plan. |
| `GATE-08` commercial, contract, and handover facts | `KT-04`, `KT-05`, `KT-07`, `KT-08`, `KT-16` | Verify current supplier capability, quotation scope, submittals, warranties, exclusions, lead time, QC records, traceability, and as-built handover. |

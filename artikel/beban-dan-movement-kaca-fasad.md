---
article_id: KT-13-03
title: "Angin, Gempa, Drift, dan Defleksi pada Kaca Fasad: Data yang Harus Dikoordinasikan"
slug: "beban-dan-movement-kaca-fasad"
description: "Identify wind zones, building movement, seismic drift, mullion deflection, slab edge, anchor movement, glass clearance, sealant movement, and serviceability questions."
status: outline
publication_date: "2026-04-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KT-13
primary_intent: "Prepare load and movement coordination inputs."
reader_community: "Kacatempered.co.id"
reader_address: "Sobat Kacatempered.co.id"
final_route: "/artikel/beban-dan-movement-kaca-fasad.html"
...
# Angin, Gempa, Drift, dan Defleksi pada Kaca Fasad: Data yang Harus Dikoordinasikan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Angin, Gempa, Drift, dan Defleksi pada Kaca Fasad: Data yang Harus Dikoordinasikan”
- **Reader and situation:** Project coordinator briefing facade and structural engineers.
- **Reader outcome:** Identify wind zones, building movement, seismic drift, mullion deflection, slab edge, anchor movement, glass clearance, sealant movement, and serviceability questions.
- **Primary intent:** Prepare load and movement coordination inputs.
...
- **Scope boundary:** Does not provide numeric loads, drift, clearance, or design checks; SNI interpretation and appointed engineers own them.
- **Final public route:** `/artikel/beban-dan-movement-kaca-fasad.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Angin, Gempa, Drift, dan Defleksi pada Kaca Fasad: Data yang Harus Dikoordinasikan**.
...
- `KT-13-01` → `/artikel/curtain-wall-sebagai-sistem.html` — Curtain Wall sebagai Sistem: Kaca, Frame, Anchor, Seal, Drainase, dan Movement
- `KT-13-02` → `/artikel/memilih-safety-glass-untuk-fasad.html` — Memilih Heat-Treated dan Laminated Glass untuk Fasad Berdasarkan Risiko
- `KT-13-04` → `/artikel/structural-silicone-glazing.html` — Structural Silicone Glazing: Desain Joint, Adhesi, Cure, dan Traceability
- `KT-13-05` → `/artikel/jalur-air-curtain-wall.html` — Jalur Air Curtain Wall: Pressure Equalization, Weep, End Dam, dan Interface
...
- **Tie back to this article:** Keep the explanation specific to “Angin, Gempa, Drift, dan Defleksi pada Kaca Fasad: Data yang Harus Dikoordinasikan”.

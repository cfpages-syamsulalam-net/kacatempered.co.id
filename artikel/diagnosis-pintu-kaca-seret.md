---
article_id: KT-09-06
title: "Pintu Kaca Seret, Membanting, atau Tidak Rata: Diagnosis Tanpa Bongkar Sendiri"
slug: "diagnosis-pintu-kaca-seret"
description: "Map symptoms to alignment, floor spring, pivots, rollers, tracks, seals, floor movement, misuse, and service escalation."
status: outline
publication_date: "2025-12-03"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KT-09
primary_intent: "Triage glass-door operating problems."
reader_community: "Kacatempered.co.id"
reader_address: "Teman Kacatempered.co.id"
final_route: "/artikel/diagnosis-pintu-kaca-seret.html"
...
# Pintu Kaca Seret, Membanting, atau Tidak Rata: Diagnosis Tanpa Bongkar Sendiri

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pintu Kaca Seret, Membanting, atau Tidak Rata: Diagnosis Tanpa Bongkar Sendiri”
- **Reader and situation:** Occupant or facility manager noticing unsafe movement.
- **Reader outcome:** Map symptoms to alignment, floor spring, pivots, rollers, tracks, seals, floor movement, misuse, and service escalation.
- **Primary intent:** Triage glass-door operating problems.
...
- **Scope boundary:** Does not instruct adjustment, cover removal, or glass handling; qualified hardware technicians own repair.
- **Final public route:** `/artikel/diagnosis-pintu-kaca-seret.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pintu Kaca Seret, Membanting, atau Tidak Rata: Diagnosis Tanpa Bongkar Sendiri**.
...
- `KT-09-07` → `/artikel/privasi-dan-akustik-partisi-kaca.html` — Privasi dan Akustik Partisi Kaca: Apa yang Ditentukan oleh Seluruh Assembly
- `KT-09-08` → `/artikel/serah-terima-pintu-dan-partisi-kaca.html` — Checklist Serah Terima Pintu dan Partisi Kaca
...
- **Tie back to this article:** Keep the explanation specific to “Pintu Kaca Seret, Membanting, atau Tidak Rata: Diagnosis Tanpa Bongkar Sendiri”.

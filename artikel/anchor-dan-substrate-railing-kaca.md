---
article_id: KT-11-05
title: "Anchor dan Substrate Railing Kaca: Pertanyaan sebelum Mengebor"
slug: "anchor-dan-substrate-railing-kaca"
description: "Cover as-built verification, edge distance concept, reinforcement, waterproofing, embedment, corrosion, tolerances, test plans, and designer approval."
status: outline
publication_date: "2026-02-04"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KT-11
primary_intent: "Verify the supporting construction before installation."
reader_community: "Kacatempered.co.id"
reader_address: "Sobat Kacatempered.co.id"
final_route: "/artikel/anchor-dan-substrate-railing-kaca.html"
...
# Anchor dan Substrate Railing Kaca: Pertanyaan sebelum Mengebor

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Anchor dan Substrate Railing Kaca: Pertanyaan sebelum Mengebor”
- **Reader and situation:** Contractor or owner with concrete, steel, or unknown substrate.
- **Reader outcome:** Cover as-built verification, edge distance concept, reinforcement, waterproofing, embedment, corrosion, tolerances, test plans, and designer approval.
- **Primary intent:** Verify the supporting construction before installation.
...
- **Scope boundary:** Does not give anchor sizes, spacing, drilling, proof loads, or repair instructions; responsible engineer and anchor manufacturer own them.
- **Final public route:** `/artikel/anchor-dan-substrate-railing-kaca.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Anchor dan Substrate Railing Kaca: Pertanyaan sebelum Mengebor**.
...
- **Exact Markdown to insert:** `![Ilustrasi railing kaca](/wp-content/uploads/2019/08/railing-kaca.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `railing kaca` as relevant content media; no pixels were inspected.
...
- `KT-11-03` → `/artikel/tempered-laminated-untuk-railing.html` — Tempered-Laminated untuk Railing: Penahanan Setelah Pecah dan Batasnya
...
- `KT-11-06` → `/artikel/drainase-dan-korosi-base-railing.html` — Drainase dan Korosi pada Base Railing Kaca Eksterior
- `KT-11-07` → `/artikel/bukti-sebelum-railing-kaca-disetujui.html` — Bukti yang Harus Ada sebelum Railing Kaca Disetujui
...
- **Tie back to this article:** Keep the explanation specific to “Anchor dan Substrate Railing Kaca: Pertanyaan sebelum Mengebor”.

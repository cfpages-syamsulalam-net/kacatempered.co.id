---
article_id: KT-13-07
title: "Submittal dan Mock-Up Curtain Wall: Bukti sebelum Produksi Massal"
slug: "submittal-dan-mock-up-curtain-wall"
description: "List drawings, calculations, materials, coatings, glass, sealants, gaskets, anchors, tests, samples, visual mock-up, performance mock-up, nonconformance, and approvals."
status: outline
publication_date: "2026-04-16"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KT-13
primary_intent: "Review facade evidence before release."
reader_community: "Kacatempered.co.id"
reader_address: "Sobat Kacatempered.co.id"
final_route: "/artikel/submittal-dan-mock-up-curtain-wall.html"
...
# Submittal dan Mock-Up Curtain Wall: Bukti sebelum Produksi Massal

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Submittal dan Mock-Up Curtain Wall: Bukti sebelum Produksi Massal”
- **Reader and situation:** Owner, consultant, or main contractor.
- **Reader outcome:** List drawings, calculations, materials, coatings, glass, sealants, gaskets, anchors, tests, samples, visual mock-up, performance mock-up, nonconformance, and approvals.
- **Primary intent:** Review facade evidence before release.
...
- **Scope boundary:** Does not validate calculations or tests; facade consultant, engineer, laboratory, and project authority own acceptance.
- **Final public route:** `/artikel/submittal-dan-mock-up-curtain-wall.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Submittal dan Mock-Up Curtain Wall: Bukti sebelum Produksi Massal**.
...
- **Exact Markdown to insert:** `![Ilustrasi Curtain Wall](/wp-content/uploads/2019/08/Curtain-Wall.jpg)`
...
- `/curtain-wall-yogyakarta.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/curtain-wall-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/curtain-wall-tuban.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/curtain-wall-tuban` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/curtain-wall-tegal.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/curtain-wall-tegal` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `KT-13-06` → `/artikel/mock-up-visual-fasad-kaca.html` — Warna, Refleksi, Distorsi, dan Anisotropi pada Mock-Up Fasad Kaca
...
- **Tie back to this article:** Keep the explanation specific to “Submittal dan Mock-Up Curtain Wall: Bukti sebelum Produksi Massal”.

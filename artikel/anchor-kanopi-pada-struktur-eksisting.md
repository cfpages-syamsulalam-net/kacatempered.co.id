---
article_id: KT-12-05
title: "Anchor Kanopi dan Struktur Eksisting: Mengelola Ketidakpastian Retrofit"
slug: "anchor-kanopi-pada-struktur-eksisting"
description: "Cover record drawings, scanning and exposure, substrate, reinforcement, waterproofing, edge condition, tests, temporary works, and approval."
status: outline
publication_date: "2026-03-08"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KT-12
primary_intent: "Plan evidence before attaching a canopy to an existing building."
reader_community: "Kacatempered.co.id"
reader_address: "Sobat Kacatempered.co.id"
final_route: "/artikel/anchor-kanopi-pada-struktur-eksisting.html"
...
# Anchor Kanopi dan Struktur Eksisting: Mengelola Ketidakpastian Retrofit

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Anchor Kanopi dan Struktur Eksisting: Mengelola Ketidakpastian Retrofit”
- **Reader and situation:** Owner adding a canopy to a finished facade.
- **Reader outcome:** Cover record drawings, scanning and exposure, substrate, reinforcement, waterproofing, edge condition, tests, temporary works, and approval.
- **Primary intent:** Plan evidence before attaching a canopy to an existing building.
...
- **Scope boundary:** Does not give anchor sizes, drilling instructions, proof loads, or substrate acceptance; appointed engineer owns investigation and design.
- **Final public route:** `/artikel/anchor-kanopi-pada-struktur-eksisting.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Anchor Kanopi dan Struktur Eksisting: Mengelola Ketidakpastian Retrofit**.
...
- **Tie back to this article:** Keep the explanation specific to “Anchor Kanopi dan Struktur Eksisting: Mengelola Ketidakpastian Retrofit”.

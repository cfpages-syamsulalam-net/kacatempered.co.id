---
article_id: KT-02-04
title: "Beban Kaca Bangunan: Angin, Impak, Berat Sendiri, dan Risiko Jatuh"
slug: "jenis-beban-pada-kaca-bangunan"
description: "Explain load vocabulary, combinations, serviceability, dynamic use, wind, impact, self-weight, maintenance, and fall consequence at concept level."
status: outline
publication_date: "2025-04-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KT-02
primary_intent: "Understand the load categories a design brief may need."
reader_community: "Kacatempered.co.id"
reader_address: "Sobat Kacatempered.co.id"
final_route: "/artikel/jenis-beban-pada-kaca-bangunan.html"
...
# Beban Kaca Bangunan: Angin, Impak, Berat Sendiri, dan Risiko Jatuh

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Beban Kaca Bangunan: Angin, Impak, Berat Sendiri, dan Risiko Jatuh”
- **Reader and situation:** Architect, owner, or contractor coordinating design.
- **Reader outcome:** Explain load vocabulary, combinations, serviceability, dynamic use, wind, impact, self-weight, maintenance, and fall consequence at concept level.
- **Primary intent:** Understand the load categories a design brief may need.
...
- **Scope boundary:** Does not provide project load values or combinations; current SNI interpretation and the responsible engineer own them.
- **Final public route:** `/artikel/jenis-beban-pada-kaca-bangunan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Beban Kaca Bangunan: Angin, Impak, Berat Sendiri, dan Risiko Jatuh**.
...
- `KT-02-02` → `/artikel/mengapa-tabel-tebal-kaca-tidak-cukup.html` — Mengapa Tabel Tebal Kaca Saja Tidak Cukup untuk Menjamin Aman
- `KT-02-03` → `/artikel/mendefinisikan-panel-tumpuan-bentang-sisi-bebas.html` — Cara Mendefinisikan Ukuran Panel, Tumpuan, Bentang, dan Sisi Bebas
- `KT-02-05` → `/artikel/lubang-takikan-dan-jarak-tepi-kaca.html` — Lubang, Takikan, dan Jarak Tepi: Mengapa Detail Pra-Tempering Kritis
- `KT-02-06` → `/artikel/toleransi-defleksi-dan-celah-kaca.html` — Toleransi, Defleksi, dan Celah: Menyepakati Kriteria Sebelum Produksi
...
- **Tie back to this article:** Keep the explanation specific to “Beban Kaca Bangunan: Angin, Impak, Berat Sendiri, dan Risiko Jatuh”.

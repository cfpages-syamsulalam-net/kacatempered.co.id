---
article_id: KT-02-05
title: "Lubang, Takikan, dan Jarak Tepi: Mengapa Detail Pra-Tempering Kritis"
slug: "lubang-takikan-dan-jarak-tepi-kaca"
description: "Explain why holes and notches are finalized before tempering, what dimensions to document, and which conflicts require fabricator review."
status: outline
publication_date: "2025-04-20"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KT-02
primary_intent: "Prepare fabrication geometry without unsafe improvisation."
reader_community: "Kacatempered.co.id"
reader_address: "Teman Kacatempered.co.id"
final_route: "/artikel/lubang-takikan-dan-jarak-tepi-kaca.html"
...
# Lubang, Takikan, dan Jarak Tepi: Mengapa Detail Pra-Tempering Kritis

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Lubang, Takikan, dan Jarak Tepi: Mengapa Detail Pra-Tempering Kritis”
- **Reader and situation:** Designer coordinating handles, fittings, or anchors.
- **Reader outcome:** Explain why holes and notches are finalized before tempering, what dimensions to document, and which conflicts require fabricator review.
- **Primary intent:** Prepare fabrication geometry without unsafe improvisation.
...
- **Scope boundary:** Does not give universal minimum edge distances or drilling instructions; fabricator limits and project design own exact geometry.
- **Final public route:** `/artikel/lubang-takikan-dan-jarak-tepi-kaca.html`
- **Appointed CMS date:** `2025-04-20` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Lubang, Takikan, dan Jarak Tepi: Mengapa Detail Pra-Tempering Kritis**.
...
- `KT-02-04` → `/artikel/jenis-beban-pada-kaca-bangunan.html` — Beban Kaca Bangunan: Angin, Impak, Berat Sendiri, dan Risiko Jatuh
...
- `KT-02-07` → `/artikel/memverifikasi-sni-kaca-dan-beban.html` — Cara Memverifikasi SNI Kaca dan Beban yang Berlaku untuk Proyek
...
- **Tie back to this article:** Keep the explanation specific to “Lubang, Takikan, dan Jarak Tepi: Mengapa Detail Pra-Tempering Kritis”.
